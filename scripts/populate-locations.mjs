...
function main() {
  ...
  cities.forEach((city, i) => {
    ...
    const location = {
      ...
      metaDescription: `Professional ${niche.toLowerCase()} services in ${city}${suburbs.length > 0 ? `, ${suburbs.slice(0, 3).join(', ')}` : ''} and surrounding areas. Call ${phone} for professional service.`,
    };
